...
* **Dashboard URL:** **[http://localhost:8000/Dashboard/login.php](http://localhost:8000/Dashboard/login.php)**
* **Customer Website URL:** **[http://localhost:8000](http://localhost:8000)**
